    ...
    class ActiveRecordAdapter < AbstractAdapter
      ...
      def self.matches_condition?(subject, name, value)
        ...
        if str_name_method.ends_with? "_any"
          meta_where_match_any_value(value, subject_value, str_name_method, "_any")
        elsif str_name_method.ends_with? "_all"
          meta_where_match_any_value(value, subject_value, str_name_method, "_all")
        else
      ...
      def meta_where_match_any_value(value, subject_value, name_method, name_method_ending)
